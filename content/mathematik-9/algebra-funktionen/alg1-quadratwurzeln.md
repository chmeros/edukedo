...
thema_code: "ALG1"
thema_title: "Quadratwurzeln und reelle Zahlen"
quelle: "KMK-Bildungsstandards Mathematik (Fassung 2022), Leitidee „Zahl", Klassenstufe 9 — frei formuliert, keine 1:1-Übernahme aus Lehrbüchern (siehe Anforderungskatalog Abschnitt 7); Themenkatalog vorläufig, vor Veröffentlichung mit konkretem Schulbuch-/Übungsmaterial gegenzuprüfen"
...
Bis Klasse 8 reichen meist die rationalen Zahlen ℚ aus — alle Zahlen, die sich als Bruch zweier ganzer Zahlen schreiben lassen, egal ob als endlicher Dezimalbruch (0,75) oder als periodischer Dezimalbruch (0,333... = 1/3). Beim Wurzelziehen stößt man jedoch schnell an eine Grenze: Es gibt keine rationale Zahl, die mit sich selbst multipliziert genau 2 ergibt. Zahlen wie √2, √3 oder √5 heißen **irrationale Zahlen**: Ihre Dezimaldarstellung bricht nie ab und wiederholt sich auch nie periodisch. Rationale und irrationale Zahlen zusammen bilden die **reellen Zahlen ℝ**, die sich lückenlos auf dem Zahlenstrahl anordnen lassen.

### Die Quadratwurzel

Für eine nichtnegative Zahl a ist die **Quadratwurzel** √a definiert als diejenige nichtnegative Zahl, die quadriert wieder a ergibt: (√a)² = a und √a ≥ 0. Der Ausdruck unter dem Wurzelzeichen heißt **Radikand**. Da eine Quadratzahl (also x²) nie negativ werden kann, ist die Quadratwurzel aus einer negativen Zahl im Bereich der reellen Zahlen nicht definiert. Die Funktion f(x) = √x hat daher den Definitionsbereich x ≥ 0.

### Rechengesetze für Wurzeln

Für nichtnegative a, b gelten folgende Regeln:

- **Produktregel:** √(a · b) = √a · √b
- **Quotientenregel:** √(a / b) = √a / √b (für b > 0)
- Eine entsprechende Regel für die Summe gibt es **nicht**: √(a + b) ist im Allgemeinen ungleich √a + √b — ein häufiger Rechenfehler.

Mithilfe der Produktregel lässt sich ein Wurzelterm **teilweise ziehen**, indem man den Radikanden in ein möglichst großes Quadratzahl-Produkt zerlegt, z. B. √50 = √(25 · 2) = √25 · √2 = 5√2.

### Nenner rational machen und Näherungswerte

Enthält der Nenner eines Bruchs eine Wurzel (z. B. 1/√3), erweitert man üblicherweise so, dass die Wurzel in den Zähler wandert: 1/√3 = √3/3. Ohne Taschenrechner lässt sich eine Wurzel wie √50 grob einordnen, indem man die benachbarten Quadratzahlen sucht: 49 = 7² und 64 = 8², also liegt √50 zwischen 7 und 8, näher an 7. Bei Wurzelgleichungen (z. B. √x = 5) führt Quadrieren beider Seiten zur Lösung, allerdings können dabei Scheinlösungen entstehen — deshalb ist die **Probe** am Ende zwingend.
...
#### Q-ALG1-01 · Multiple Choice
**Frage:** Welche der folgenden Zahlen ist irrational?
- [ ] 0,75
- [ ] √16
- [x] √7
- [ ] 2/3
...
- Quadratwurzel ↔ nichtnegative Zahl, die quadriert den Radikanden ergibt
- Irrationale Zahl ↔ reelle Zahl, die sich nicht als Bruch ganzer Zahlen darstellen lässt
