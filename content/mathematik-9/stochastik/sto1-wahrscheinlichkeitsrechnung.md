...
`tags: grundbegriffe` · `schwierigkeit: mittel` · `bloom: verstehen`
...
`tags: laplace` · `schwierigkeit: leicht` · `bloom: erinnern`
...
`tags: baumdiagramm` · `schwierigkeit: leicht` · `bloom: verstehen`
...
`tags: pfadregel` · `schwierigkeit: mittel` · `bloom: erinnern`
...
`tags: summenregel` · `schwierigkeit: mittel` · `bloom: erinnern`
...
`tags: mit-zuruecklegen` · `schwierigkeit: mittel` · `bloom: verstehen`
...
`tags: ohne-zuruecklegen` · `schwierigkeit: mittel` · `bloom: verstehen`
...
`tags: vierfeldertafel` · `schwierigkeit: leicht` · `bloom: verstehen`
...
`tags: rechenbeispiel, pfadregel` · `schwierigkeit: mittel` · `bloom: anwenden`
...
`tags: rechenbeispiel, ohne-zuruecklegen` · `schwierigkeit: schwer` · `bloom: anwenden`
...
`tags: rechenbeispiel, summenregel, gegenereignis` · `schwierigkeit: schwer` · `bloom: analysieren`
...
`tags: gegenereignis` · `schwierigkeit: mittel` · `bloom: verstehen`
...
`tags: rechenbeispiel, vierfeldertafel` · `schwierigkeit: mittel` · `bloom: anwenden`
...
`tags: ohne-zuruecklegen, vertiefung` · `schwierigkeit: schwer` · `bloom: analysieren`
