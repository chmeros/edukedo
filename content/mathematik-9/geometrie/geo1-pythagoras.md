...
thema_code: "GEO1"
thema_title: "Satz des Pythagoras"
quelle: "KMK-Bildungsstandards Mathematik (Fassung 2022), Leitideen „Raum und Form" sowie „Größen und Messen", Klassenstufe 9 — frei formuliert, keine 1:1-Übernahme aus Lehrbüchern (siehe Anforderungskatalog Abschnitt 7); Themenkatalog vorläufig, vor Veröffentlichung mit konkretem Schulbuch-/Übungsmaterial gegenzuprüfen"
...
In einem **rechtwinkligen Dreieck** heißen die beiden Seiten, die den rechten Winkel einschließen, **Katheten** (meist a und b genannt), und die dem rechten Winkel gegenüberliegende, längste Seite heißt **Hypotenuse** (meist c genannt). Der Satz des Pythagoras besagt:

a² + b² = c²

Die Summe der Kathetenquadrate ist gleich dem Hypotenusenquadrat. Der Satz gilt ausschließlich für rechtwinklige Dreiecke und erlaubt, aus zwei bekannten Seiten die dritte zu berechnen — je nachdem, ob die Hypotenuse oder eine Kathete gesucht ist, muss die Formel entsprechend nach a, b oder c umgestellt werden.

### Der Umkehrsatz

Der **Umkehrsatz des Pythagoras** funktioniert in die andere Richtung: Gilt in einem Dreieck mit den Seiten a, b, c (c die längste Seite) die Beziehung a² + b² = c², so ist das Dreieck rechtwinklig, mit dem rechten Winkel gegenüber der Seite c. Damit lässt sich ohne Winkelmessung prüfen, ob ein gegebenes Dreieck rechtwinklig ist — man muss nur die drei Seitenlängen kennen.

### Anwendungen in ebenen Figuren

Der Satz des Pythagoras taucht in vielen ebenen Figuren versteckt auf, auch wenn kein rechtwinkliges Dreieck explizit gezeichnet ist:

- Die **Diagonale eines Rechtecks** mit den Seiten a und b lässt sich über d = √(a² + b²) berechnen, da die Diagonale zusammen mit zwei Seiten ein rechtwinkliges Dreieck bildet.
- Bei einem **Quadrat** mit Seitenlänge a gilt entsprechend für die Diagonale d = a√2.
- Die **Höhe in einem gleichschenkligen Dreieck** lässt sich berechnen, indem man das Dreieck durch die Höhe in zwei kongruente rechtwinklige Dreiecke teilt.

### Anwendungen in Körpern

Auch bei dreidimensionalen Körpern hilft der Satz des Pythagoras weiter, meist in zwei Schritten:

- Die **Raumdiagonale eines Quaders** mit den Kantenlängen a, b, c berechnet man, indem man zunächst die Flächendiagonale einer Grundfläche bestimmt (z. B. e = √(a² + b²)) und diese dann mit der dritten Kante erneut über Pythagoras verrechnet: d = √(e² + c²) = √(a² + b² + c²).
- Bei einer **Pyramide** oder einem **Kegel** lässt sich die Höhe aus der Seitenkante bzw. Mantellinie und dem Abstand vom Mittelpunkt der Grundfläche zum Rand berechnen, ebenfalls über ein rechtwinkliges Dreieck im Inneren des Körpers.
...
#### Q-GEO1-01 · Multiple Choice
**Frage:** Wie lautet der Satz des Pythagoras für ein rechtwinkliges Dreieck mit Katheten a, b und Hypotenuse c?
- [ ] a + b = c
- [x] a² + b² = c²
- [ ] a² − b² = c²
- [ ] a · b = c²
...
- Hypotenuse ↔ dem rechten Winkel gegenüberliegende, längste Seite
- Kathete ↔ Seite, die den rechten Winkel mit einschließt
