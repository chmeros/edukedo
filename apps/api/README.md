...
- **tRPC-Router-Grundstruktur:** `src/trpc/router.ts` (aktuell `health`, `auth`; weitere Module folgen modulweise).
- **Noch offen:** Consent-/Eltern-Flow (Iteration 2), Content-/Courses-/Progress-Router (ab Iteration 1), Sozial-Modul (Phase 4).
