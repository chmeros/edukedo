...
/**
 * F-90: Eltern-Dashboard-Grundgerüst. Berechtigungsverwaltung beschränkt sich zum Start auf
 * Einwilligungsstatus einsehen + Widerruf (siehe Anforderungskatalog Abschnitt 5.11) — eine
 * konkrete Berechtigung wie F-66 (Gamification) existiert noch nicht (erst Iteration 6),
 * es gibt also aktuell nichts darüber hinaus zu verwalten.
 */
