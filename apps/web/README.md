...
- **Karteikarten-Modus (F-20):** `src/Flashcards.tsx` — fällige Karten anzeigen, Antwort aufdecken, Selbsteinschätzung (nicht gewusst/unsicher/gewusst) an `progress.submitReview` melden.
